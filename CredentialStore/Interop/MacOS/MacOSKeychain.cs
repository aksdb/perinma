...
using static CredentialStore.Interop.MacOS.Native.CoreFoundation;
using static CredentialStore.Interop.MacOS.Native.SecurityFramework;

namespace CredentialStore.Interop.MacOS
{
