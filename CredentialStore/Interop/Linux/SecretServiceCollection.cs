...
using System.Text;
using static CredentialStore.Interop.Linux.Native.Gobject;
using static CredentialStore.Interop.Linux.Native.Glib;
using static CredentialStore.Interop.Linux.Native.Libsecret;
using static CredentialStore.Interop.Linux.Native.Libsecret.SecretSchemaAttributeType;
using static CredentialStore.Interop.Linux.Native.Libsecret.SecretSchemaFlags;

namespace CredentialStore.Interop.Linux
{
